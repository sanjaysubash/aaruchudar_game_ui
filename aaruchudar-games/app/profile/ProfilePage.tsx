  ...
  const achievements = [
    {
      ...
      label: "7-Day Streak",
      icon: "🔥",
      grad: "from-amber-400/30 to-rose-500/30",
    },
    {
      id: "xp1k",
      label: "1,000 XP",
      icon: "🏆",
      grad: "from-yellow-300/30 to-amber-400/30",
    },
    {
      id: "logicPro",
      label: "Logic Pro",
      icon: "🧩",
      grad: "from-cyan-400/30 to-blue-500/30",
    },
    {
      id: "speedster",
      label: "Speedster",
      icon: "⚡",
      grad: "from-rose-500/30 to-fuchsia-500/30",
    },
  ];
  ...
  return (
    <div className="section-space r-space r-gap">
      <header className="mb-8 relative text-center overflow-hidden">
        ...
        <h1 className="text-4xl sm:text-5xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 via-fuchsia-300 to-amber-300">
          Your Arcade Profile
        </h1>
        <p className="mt-2 text-sm text-white/80">
          Welcome back, {me.name}. Keep the streak alive.
        </p>
      </header>
      ...
      <section className="grid grid-cols-1 md:grid-cols-[320px_1fr] gap-6">
        <div className="rounded-2xl p-5 border border-white/10 bg-white/5">
          <div className="flex items-center gap-4">
            <div className="relative">
              <div
                className="h-16 w-16 rounded-2xl grid place-items-center text-lg font-bold text-white bg-black/30 border border-white/20 ring-4 ring-transparent"
            ...
            <div className="min-w-0">
              ...
              <div className="mt-2 inline-flex items-center gap-2">
                ...
                {me.rankName && (
                  <span className="text-[10px] px-2 py-0.5 rounded-full bg-black/30 border border-white/20">
                    {me.rankName}
                  </span>
                )}
              </div>
          ...
          <div className="mt-5">
            <div className="flex items-center justify-between text-xs text-white/80 mb-1">
              ...
              <span>
                {progress}% to {nextXp.toLocaleString()}
              </span>
            </div>
            <div className="h-2.5 w-full bg-white/10 rounded-full overflow-hidden border border-white/10">
              <div
                className="h-full bg-gradient-to-r from-cyan-500 via-fuchsia-500 to-amber-400"
        ...
        <div className="rounded-2xl p-5 border border-white/10 bg-white/5">
          <div className="text-[11px] tracking-widest mb-3 text-white/80">
            ACHIEVEMENTS
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {achievements.map((a) => (
              <div
                key={a.id}
                className={`relative rounded-xl p-3 border border-white/10 bg-gradient-to-br ${a.grad}`}
              >
                <div className="text-2xl drop-shadow-[0_2px_6px_rgba(0,0,0,0.35)]">
                  {a.icon}
                </div>
        ...
        <div className="rounded-2xl p-5 border border-white/10 bg-white/5">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {[
              {
                label: "Logic",
                value: me.dimensions?.logic ?? 0,
                grad: "from-cyan-500/20 to-blue-500/20",
              },
              {
                label: "Creativity",
                value: me.dimensions?.creativity ?? 0,
                grad: "from-pink-500/20 to-purple-500/20",
              },
              {
                label: "EQ",
                value: me.dimensions?.empathy ?? 0,
                grad: "from-emerald-400/20 to-teal-400/20",
              },
              {
                label: "Speed",
                value: 42,
                grad: "from-rose-500/20 to-fuchsia-500/20",
              },
            ].map((s) => (
              <div
                key={s.label}
                className={`rounded-xl p-3 border border-white/10 bg-gradient-to-br ${s.grad}`}
              >
      ...
      <section className="mt-6">
        <div className="rounded-2xl p-5 border border-white/10 bg-white/5">
          <div className="flex items-center justify-between mb-3">
            <div className="text-[11px] tracking-widest text-white/80">
              RECENTLY PLAYED
            </div>
            <Link
              href="/games"
